  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.profile == null ? "Nuevo registro" : "Actulizar datos",
                ...
                Padding(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      if (widget.profile == null) {
                        _profileService.createProfile(profile).then((isSuccess) {
                        ...
                        _profileService.updateProfile(profile).then((isSuccess) {
                          setState(() => _isLoading = false);
                          if (isSuccess) {
                            Navigator.pop(_scaffoldState.currentState.context);
                          } else {
